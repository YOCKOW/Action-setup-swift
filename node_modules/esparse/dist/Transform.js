...
class Transform {
    ...
    for (let i = 0; i < props.length; ++i) {
      ...
      switch (prop.type) {
        case 'PropertyDefinition':
          prop = this.node(new AST.PatternProperty(prop.name, prop.expression, null), prop.start, prop.end);
          break;
        case 'SpreadExpression':
  ...
  transformIdentifier(node) {
    ...
    if (_Scanner.isReservedWord(value)) this.fail('Unexpected token ' + value, node);
